...
export function NotionIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <rect width="16" height="16" rx="1.5" fill="#000" />
      <path
        d="M4 4h2.3l3.7 5.2V4H12v8H9.7L6 6.8V12H4V4z"
        fill="white"
      />
    </svg>
  );
...
export function LinearIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M2 9.3L6.7 14H14V8.7L9.3 4 2 9.3z" fill="#5E6AD2" />
      <path d="M2 7.3L8.7 2 13 6.3 6.3 13 2 7.3z" fill="#5E6AD2" opacity="0.55" />
    </svg>
  );
}
...
// Maps URL hostname patterns to icon components.
